#!/usr/bin/env python3
"""DORA Metrics CLI for opendatahub-operator."""
...
from collector import ai_commit_detector, branch_tracker, cherry_pick_detector, pr_collector, revert_detector, tag_collector
...
def _print_text_report(result: dict) -> None:
    click.echo()
    click.echo("=" * 70)
    click.echo("  DORA Metrics Report: opendatahub-operator")
    click.echo("=" * 70)
